    ...
    <Helmet title={productName}>
            ...
            <Col lg="6">
              <div className="product__details">
                ...
                <motion.div
                  ...
                  className={`d-flex align-items-center gap-2 product__wishlist`}
                >
                  {toggleWishList ? (
                    <>
                      <i className="ri-heart-2-fill"></i>
                      <p>Product already in wishlist browse</p>
                    </>
                  ) : (
                    <>
      ...
      <section>
        <Container>
          <Row>
            <Col lg="12">
              <div className="tap__wrapper d-flex algin-items-center gap-5">
                <h6
